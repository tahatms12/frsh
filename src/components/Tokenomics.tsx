    ...
    <section id="tokenomics" className="py-16 lg:py-24 relative z-10">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="panel p-8"
        >
          <h3 className="text-3xl font-bold mb-8 text-center neon-text">Token Distribution</h3>
                ...
                {distribution.map((item, index) => {
                  ...
                  return (
                    <div
                      ...
                      style={{
                        clipPath: `polygon(50% 50%, 50% 0%, ${50 + 50 * Math.sin((angle * Math.PI) / 180)}% ${
        ...
        >
          <h3 className="text-3xl font-bold mb-6 text-center electric-text">Airdrop Eligibility</h3>
